...
//
//	mockgen -source=category_repository.go -destination=../../../mock/repository/category_repository_mock.go -package=mock_repository
//
...
import (
	...
	categories "github.com/haru-256/practical-go-grpc-micro-service/service/command/internal/domain/models/categories"
...
func (m *MockCategoryRepository) Create(ctx context.Context, tx *sql.Tx, category *categories.Category) error {
	m.ctrl.T.Helper()
...
func (m *MockCategoryRepository) DeleteById(ctx context.Context, tx *sql.Tx, id *categories.CategoryId) error {
	m.ctrl.T.Helper()
...
func (m *MockCategoryRepository) DeleteByName(ctx context.Context, tx *sql.Tx, name *categories.CategoryName) error {
	m.ctrl.T.Helper()
...
func (m *MockCategoryRepository) ExistsByName(ctx context.Context, tx *sql.Tx, name *categories.CategoryName) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockCategoryRepository) FindById(ctx context.Context, tx *sql.Tx, id *categories.CategoryId) (*categories.Category, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindById", ctx, tx, id)
	ret0, _ := ret[0].(*categories.Category)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockCategoryRepository) UpdateById(ctx context.Context, tx *sql.Tx, category *categories.Category) error {
	m.ctrl.T.Helper()
